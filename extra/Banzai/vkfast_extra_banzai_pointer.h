...
GPU_API_PRE void GPU_API_POST vfeBanzaiPointerGetRawLimited(const gpu_extra_banzai_pointer_t * banzai_pointer, uint64_t bytes_count, RedStructMemberArray * out_banzai_pointer_raw, const char * optional_file, int optional_line);
GPU_API_PRE void GPU_API_POST vfeBanzaiPointerGetRawCapped(const gpu_extra_banzai_pointer_t * banzai_pointer, uint64_t bytes_count_cap, RedStructMemberArray * out_banzai_pointer_raw, const char * optional_file, int optional_line);
