...
L"\n"
L"The source code for \"The best binary to run on Switch\" compiler, gen64 from Feb 10, 2025." L"\n"
L"Copyright(C) 2024 Constantine Tarasenkov (iamvfx@gmail.com). All rights reserved." L"\n"
L"\n"
