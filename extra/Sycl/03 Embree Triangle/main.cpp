...
icpx -fsycl -fsycl-targets=spir64 -Xclang -fsycl-allow-func-ptr -I/opt/intel-embree/include -L/opt/intel-embree/build/ main.cpp -lembree4_sycl -lembree4 -o sycl_embree_triangle_demo
LD_LIBRARY_PATH=/opt/intel-embree/build/:$LD_LIBRARY_PATH ./sycl_embree_triangle_demo
#endif
