...
private:
  ...
  void createRtxPipeline()
  {
    ...
    // Raygen
    stage.module    = nvvk::createShaderModule(m_device, raytrace_rgen_glsl, sizeof(raytrace_rgen_glsl));
    stage.stage     = VK_SHADER_STAGE_RAYGEN_BIT_KHR;
    stages[eRaygen] = stage;
    m_dutil->setObjectName(stage.module, "Raygen");
    // Miss
    stage.module  = nvvk::createShaderModule(m_device, raytrace_rmiss_glsl, sizeof(raytrace_rmiss_glsl));
    stage.stage   = VK_SHADER_STAGE_MISS_BIT_KHR;
    stages[eMiss] = stage;
    m_dutil->setObjectName(stage.module, "Miss");
    // Hit Group - Closest Hit
    stage.module        = nvvk::createShaderModule(m_device, raytrace_rchit_glsl, sizeof(raytrace_rchit_glsl));
