...
typedef struct gpu_context_ex2_import_parameters_t {
...
} gpu_context_ex2_import_parameters_t;

GPU_API_PRE gpu_handle_context_t GPU_API_POST vfContextInitEx2(int enable_debug_mode, unsigned gpu_index, const gpu_context_optional_parameters_t * optional_parameters, const gpu_context_ex2_import_parameters_t * import_parameters, const char * optional_file, int optional_line);
...
GPU_API_PRE uint64_t GPU_API_POST vfAsyncBatchExecuteRawEx(gpu_handle_context_t context, RedHandleQueue queue, uint64_t batch_raw_count, const RedHandleCalls * batch_raw, const char * optional_file, int optional_line);
