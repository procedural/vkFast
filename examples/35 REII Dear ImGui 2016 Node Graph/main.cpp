...
int main() {
  ...
  GLFWwindow * window = glfwCreateWindow(window_w, window_h, "[vkFast] REII Dear ImGui 2016 Node Graph", 0, 0);
#if defined(_WIN32)
  ...
  vfWindowFullscreen(ctx, window_handle, "[vkFast] REII Dear ImGui 2016 Node Graph", window_w, window_h, 0, RED_PRESENT_VSYNC_MODE_ON, FF, LL);
