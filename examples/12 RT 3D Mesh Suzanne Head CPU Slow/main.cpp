...
int main() {
  ...
  GLFWwindow * window = glfwCreateWindow(window_w, window_h, "[vkFast] RT 3D Mesh Suzanne Head CPU Slow", 0, 0);
#if defined(_WIN32)
  ...
  vfWindowFullscreen(ctx, window_handle, "[vkFast] RT 3D Mesh Suzanne Head CPU Slow", 700, 700, 0, RED_PRESENT_VSYNC_MODE_ON, FF, LL);
