...
int main() {
  gpu_handle_context_t ctx = vfeArcContextInit(1, NULL, FF, LL);
  ...
  // ReBAR Heap 0 Test
  {
    ...
    void * part1_4GB = vfeArcMallocSharedB580ReBARHeap0v1(ctx, 4ULL * 1024*1024*1024 - 64, &part1_4GB_array);
    void * part2_4GB = vfeArcMallocSharedB580ReBARHeap0v1(ctx, 4ULL * 1024*1024*1024 - 64, &part2_4GB_array);
    void * part3_2GB = vfeArcMallocSharedB580ReBARHeap0v1(ctx, 2ULL * 1024*1024*1024 - 64, &part3_2GB_array);

    REDGPU_2_EXPECTFL(part1_4GB != NULL);
    REDGPU_2_EXPECTFL(part2_4GB != NULL);
    REDGPU_2_EXPECTFL(part3_2GB != NULL);

    vfeArcFreeSharedB580ReBARHeap(ctx, &part1_4GB_array);
    vfeArcFreeSharedB580ReBARHeap(ctx, &part2_4GB_array);
    vfeArcFreeSharedB580ReBARHeap(ctx, &part3_2GB_array);
    part1_4GB = NULL;
    part2_4GB = NULL;
    part3_2GB = NULL;
  }
