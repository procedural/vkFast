...
int main() {
  ...
  GLFWwindow * window = glfwCreateWindow(window_w, window_h, "[vkFast] ReBAR REII Rotation", 0, 0);
#if defined(_WIN32)
  ...
  vfWindowFullscreen(ctx, window_handle, "[vkFast] ReBAR REII Rotation", window_w, window_h, 0, RED_PRESENT_VSYNC_MODE_ON, FF, LL);
