...
int main() {
  ...
  GLFWwindow * window = glfwCreateWindow(window_w, window_h, "[vkFast] REII Blender Simple Importer 1.0", 0, 0);
  ...
  vfWindowFullscreen(ctx, window_handle, "[vkFast] REII Blender Simple Importer 1.0", window_w, window_h, 0, RED_PRESENT_VSYNC_MODE_ON, FF, LL);
  ...
  enum blender_mesh_enums {
    #include "BlenderMeshHeaders/06_May_2026_21h_44m_54s/mesh_enums.h"
    BLENDER_MESH_ENUMS_COUNT
  };
  struct int3 blender_mesh_indices[] = {
    #include "BlenderMeshHeaders/06_May_2026_21h_44m_54s/mesh_indices.h"
  };
  struct float4 blender_mesh_normals[] = {
    #include "BlenderMeshHeaders/06_May_2026_21h_44m_54s/mesh_normals.h"
  };
  struct float2 blender_mesh_uvs[] = {
    #include "BlenderMeshHeaders/06_May_2026_21h_44m_54s/mesh_uvs.h"
  };
  struct float4 blender_mesh_vertices[] = {
    #include "BlenderMeshHeaders/06_May_2026_21h_44m_54s/mesh_vertices.h"
  };
  uint64_t blender_submesh_tri_begin[] = {
    #include "BlenderMeshHeaders/06_May_2026_21h_44m_54s/submesh_tri_begin.h"
  };
  uint64_t blender_submesh_tri_end[] = {
    #include "BlenderMeshHeaders/06_May_2026_21h_44m_54s/submesh_tri_end.h"
  };
  struct float4 blender_submesh_xform_scale[] = {
    #include "BlenderMeshHeaders/06_May_2026_21h_44m_54s/submesh_xform_scale.h"
  };
  struct float4 blender_submesh_xform_rotation_quaternion[] = {
    #include "BlenderMeshHeaders/06_May_2026_21h_44m_54s/submesh_xform_rotation_quaternion.h"
  };
  struct float4 blender_submesh_xform_translation[] = {
    #include "BlenderMeshHeaders/06_May_2026_21h_44m_54s/submesh_xform_translation.h"
  };
